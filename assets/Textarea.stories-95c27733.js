import{T as s}from"./Textarea-0f1928d4.js";import"./jsx-runtime-68f49b4e.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";import"./ErrorMessage-07ea8fac.js";import"./FormGroup-f91b51d3.js";const n="textarea",i=[{name:"default",options:{name:"more-detail",id:"more-detail",label:{text:"Can you provide more detail?"}},hidden:!1,html:`<div class="govuk-form-group">
...
</div>`}],l={component:n,fixtures:i},B={title:"Textarea",component:s},o={name:"default"},d={name:"with hint"},h={name:"with error message"},c={name:"with default value"},u={name:"with custom rows"},b={name:"with label as page heading"},m={name:"with optional formgroup classes"},p={name:"with autocomplete attribute"},g={name:"with spellcheck enabled"},v={name:"with spellcheck disabled"},a=[];a.push(o);a.push(d);a.push(h);a.push(c);a.push(u);a.push(b);a.push(m);a.push(p);a.push(g);a.push(v);l.fixtures.forEach(e=>{let t=a.find(r=>r.name===e.name.replace(/[^a-z0-9s]/gi,""))||{};t.name===e.name&&(t.args={name:e.options.name,id:e.options.id,label:e.options.label,rows:e.options.rows,autocomplete:e.options.autocomplete,spellcheck:e.options.spellcheck,classes:e.options.classes,attributes:e.options.attributes,describedBy:e.options.describedBy})});const W=["primary","withHint","withErrorMessage","withDefaultValue","withCustomRows","withLabelAsPageHeading","withOptionalFormgroupClasses","withAutocompleteAttribute","withSpellcheckEnabled","withSpellcheckDisabled"];export{W as __namedExportsOrder,B as default,o as primary,p as withAutocompleteAttribute,u as withCustomRows,c as withDefaultValue,h as withErrorMessage,d as withHint,b as withLabelAsPageHeading,m as withOptionalFormgroupClasses,v as withSpellcheckDisabled,g as withSpellcheckEnabled};
//# sourceMappingURL=Textarea.stories-95c27733.js.map
