import{P as o}from"./PhaseBanner-809e0913.js";import"./jsx-runtime-670450c2.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";const i="phase-banner",r=[{name:"default",options:{tag:{text:"alpha"},html:'This is a new service - your <a href="#" class="govuk-link">feedback</a> will help us to improve it.'},hidden:!1,html:`<div class="govuk-phase-banner">
...
</div>`}],l={component:i,fixtures:r},v={title:"PhaseBanner",component:o},p={name:"default"},a=[];a.push(p);l.fixtures.forEach(e=>{var s;let n=a.find(t=>t.name===e.name.replace(/[^a-z0-9s]/gi,""))||{};n.name===e.name&&(n.args={children:e.options.html,className:e.options.classes,phase:(s=e.options.tag)==null?void 0:s.text,attributes:e.options.attributes})});const k=["primary"];export{k as __namedExportsOrder,v as default,p as primary};
//# sourceMappingURL=PhaseBanner.stories-b4bf0bea.js.map
