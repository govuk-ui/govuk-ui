import{D as o}from"./DateInput-4b08d3af.js";import"./jsx-runtime-68f49b4e.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";import"./FormGroup-f91b51d3.js";import"./ErrorMessage-07ea8fac.js";import"./Input-70154cc0.js";import"./Hint-47130fa7.js";import"./Label-3d09487c.js";import"./Fieldset-cd643f71.js";import"./Legend-645732ce.js";import"./Typography-3950099a.js";const a="date-input",u=[{name:"default",options:{id:"dob"},hidden:!1,html:`<div class="govuk-form-group">
...
</div>`}],d={component:a,fixtures:u},O={title:"DateInput",component:o},s={name:"default"},l={name:"complete question"},r={name:"with errors only"},v={name:"with errors and hint"},p={name:"with error on day input"},m={name:"with error on month input"},g={name:"with error on year input"},k={name:"with default items"},c={name:"with optional formgroup classes"},b={name:"with autocomplete values"},h={name:"with input attributes"},n=[];n.push(s);n.push(l);n.push(r);n.push(v);n.push(p);n.push(m);n.push(g);n.push(k);n.push(c);n.push(b);n.push(h);d.fixtures.forEach(t=>{let e=n.find(i=>i.name===t.name.replace(/[^a-z0-9s]/gi,""))||{};e.name===t.name&&(e.args={id:t.options.id,classes:t.options.classes,attributes:t.options.attributes})});const P=["primary","completeQuestion","withErrorsOnly","withErrorsAndHint","withErrorOnDayInput","withErrorOnMonthInput","withErrorOnYearInput","withDefaultItems","withOptionalFormgroupClasses","withAutocompleteValues","withInputAttributes"];export{P as __namedExportsOrder,l as completeQuestion,O as default,s as primary,b as withAutocompleteValues,k as withDefaultItems,p as withErrorOnDayInput,m as withErrorOnMonthInput,g as withErrorOnYearInput,v as withErrorsAndHint,r as withErrorsOnly,h as withInputAttributes,c as withOptionalFormgroupClasses};
//# sourceMappingURL=DateInput.stories-54295b03.js.map
