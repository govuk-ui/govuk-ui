  ...
  const autofocusExplicitlyEnabledWithTypeAsSuccess: Story = { name: 'autofocus explicitly enabled with type as success' }
  const rolealertOverriddenToRoleregionWithTypeAsSuccess: Story = { name: 'rolealert overridden to roleregion with type as success' }
