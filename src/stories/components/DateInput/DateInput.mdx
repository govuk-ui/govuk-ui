...
<Canvas of={DateInputStories.primary} />
...
<Canvas of={DateInputStories.twoQuestions} />
...
<Canvas of={DateInputStories.birthday} />
...
<Canvas of={DateInputStories.errorExample} />
...
<Canvas of={DateInputStories.errorExampleYear} />

Make sure errors follow the guidance in error message and have specific error messages for specific error states.

If there’s more than one error, show the highest priority <a class="govuk-link" href="https://design-system.service.gov.uk/components/error-message/">error message</a>. In order of priority, show error messages about:
