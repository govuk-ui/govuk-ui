...
const summary: Story = {
  ...
  render: (args) => (
    <Accordion id={'example-summary-accordion'}>
      <AccordionItem heading="Understanding agile project management" summary="Introductions, methods, core features.">
      ...
      <AccordionItem heading="Working with agile methods" summary="Workspaces, tools and techniques, user stories, planning.">
      ...
      <AccordionItem heading="Governing agile services" summary="Principles, measuring progress, spending money.">
        ...
        <Typography>Spend controls: check if you need approval to spend money on a service</Typography>
      ...
      <AccordionItem heading="Phases of an agile project" summary="Discovery, alpha, beta, live and retirement.">
