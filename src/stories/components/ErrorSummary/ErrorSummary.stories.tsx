...
const linking: Story = {
  ...
  render: (_args) => (
    <>
      <ErrorSummary>
        <ErrorSummaryMessage id="full-name-input">Enter your full name</ErrorSummaryMessage>
      </ErrorSummary>
  ...
  render: (_args) => (
    <>
      ...
      <DateInput
        id="passport-issued"
        errorYear
        errorMessage="Passport issue date must include a year"
      >
...
export { primary, linking, linkingDateInput, checkboxes, fullPageExample };
