...
<Canvas of={InputStories.withoutHeading} />
...
<Canvas of={InputStories.fixedWidthInputs} />
...
<Canvas of={InputStories.fluidWidthInputs} />

## Hint text

Use hint text for help that’s relevant to the majority of users, like how their information will be used, or where to find it.

<Canvas of={InputStories.hintText} />
...
<Canvas of={InputStories.numberWithDecimals} />
...
<Canvas of={InputStories.prefixAndSuffix} />
...
<Canvas of={InputStories.prefix} />

### Text inputs with a suffix

<Canvas of={InputStories.suffix} />
...
<Canvas of={InputStories.spellcheck} />

Browsers do not consistently spellcheck user’s input by default. If you are asking a question where spellcheck would be useful, set the `spellcheck` prop to `true`.
...
<Canvas of={InputStories.prefixSuffixError} />
