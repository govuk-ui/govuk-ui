...
import { Tag, Table, TableHeader, TableRow, TableCell } from "../../../components";
...
const primary: Story = {
  name: "default",
  render: (_args) => <Tag>COMPLETED</Tag>,
};
  ...
  render: (_args) => (
    <Table>
      ...
      <TableRow>
        ...
        <TableCell>
          <Tag className="govuk-tag--grey">INACTIVE</Tag>
        </TableCell>
      </TableRow>
      <TableRow>
  ...
  render: (_args) => (
    <Table>
      ...
      <TableRow>
        <TableCell>Rachael Pepper</TableCell>
        <TableCell>
          <Tag className="govuk-tag--green">FINISHED</Tag>
        </TableCell>
      </TableRow>
      <TableRow>
        <TableCell>Emma Tennant</TableCell>
        <TableCell>
          <Tag className="govuk-tag--yellow">WAITING ON</Tag>
        </TableCell>
      </TableRow>
    </Table>
  ),
  ...
  render: (_args) => (
    <Table>
      ...
      <TableRow>
        ...
        <TableCell>
          <Tag className="govuk-tag--turquoise">ACTIVE</Tag>
        </TableCell>
      </TableRow>
      <TableRow>
        <TableCell>
        ...
        <TableCell>
          <Tag className="govuk-tag--blue">PENDING</Tag>
        </TableCell>
      </TableRow>
      <TableRow>
        <TableCell>
        ...
        <TableCell>
          <Tag className="govuk-tag--purple">RECEIVED</Tag>
        </TableCell>
      </TableRow>
      <TableRow>
        <TableCell>
        ...
        <TableCell>
          <Tag className="govuk-tag--pink">SENT</Tag>
        </TableCell>
      </TableRow>
      <TableRow>
        <TableCell>
        ...
        <TableCell>
          <Tag className="govuk-tag--red">REJECTED</Tag>
        </TableCell>
      </TableRow>
      <TableRow>
        <TableCell>
        ...
        <TableCell>
          <Tag className="govuk-tag--orange">DECLINED</Tag>
        </TableCell>
      </TableRow>
      <TableRow>
        <TableCell>
        ...
        <TableCell>
          <Tag className="govuk-tag--yellow">DELAYED</Tag>
        </TableCell>
      </TableRow>
    </Table>
  ),
