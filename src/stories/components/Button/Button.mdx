...
import {ArgsTable, ArgTypes, Canvas, Controls} from '@storybook/addon-docs';
...
<Canvas of={ButtonStories.groupWithLink}/>
...
To do this, set the `preventDoubleClick` prop as shown in this example.

<Canvas of={ButtonStories.preventDoubleClick}/>
