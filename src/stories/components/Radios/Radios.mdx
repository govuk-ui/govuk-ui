...
import { Canvas } from '@storybook/addon-docs'; import { GovScript } from '../../extras/GovScript';

<Meta title="Components/Radios" />

<Hint>Components</Hint>

# Radios

<Canvas of={RadioStories.withHeading}/>
...
<Canvas of={RadioStories.withoutHeading} />
...
<Canvas of={RadioStories.withHint} />
...
<Canvas of={RadioStories.withDivider} />
...
<Canvas of={RadioStories.conditional} />
...
Users are not always notified when a conditionally revealed question is shown or hidden. This fails <a href="https://www.w3.org/WAI/WCAG21/Understanding/name-role-value.html">WCAG 2.1 success criterion 4.1.2 Name, Role, Value</a>.
...
<Canvas of={RadioStories.conditionalWithErrors} />
