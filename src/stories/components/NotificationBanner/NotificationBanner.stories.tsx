...
import { Typography, NotificationBanner } from "../../..";
...
const green: Story = {
  name: "Notification banner",
  render: (_args) => (
    <NotificationBanner title="Success" type="success" role="alert">
      <Typography variant="m">Training outcome recorded and trainee withdrawn</Typography>
      <Typography>
        Contact{" "}
...
export { primary, coronavirus, green };
