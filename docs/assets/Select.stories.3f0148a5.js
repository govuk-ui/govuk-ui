import{S as i}from"./Select.65ff998c.js";import{j as l}from"./jsx-runtime.999029ca.js";import"./index.ef27e5dc.js";import"./_commonjsHelpers.712cc82f.js";const a="select",r=[{name:"default",options:{id:"select-1",name:"select-1",label:{text:"Label text goes here"},items:[{value:1,text:"GOV.UK frontend option 1"},{value:2,text:"GOV.UK frontend option 2",selected:!0},{value:3,text:"GOV.UK frontend option 3",disabled:!0}]},hidden:!1,html:`<div class="govuk-form-group">
...
</div>`}],d={component:a,fixtures:r},O={title:"Select",component:i},c={name:"default"},u={name:"with no items"},p={name:"with selected value"},v={name:"with hint text and error message"},h={name:"with label as page heading"},m={name:"with full width override"},g={name:"with optional formgroup classes"},t=[];t.push(c);t.push(u);t.push(p);t.push(v);t.push(h);t.push(m);t.push(g);d.fixtures.forEach(e=>{var s;let o=t.find(n=>n.name===e.name.replace(/[^a-z0-9s]/gi,""))||{};o.name===e.name&&(o.args={id:e.options.id,name:e.options.name,children:(s=e.options.items)==null?void 0:s.map(n=>l("option",{value:n.value,selected:n.selected,disabled:n.disabled,children:n.text})),classes:e.options.classes,describedBy:e.options.describedBy,attributes:e.options.attributes})});const k=["primary","withNoItems","withSelectedValue","withHintTextAndErrorMessage","withLabelAsPageHeading","withFullWidthOverride","withOptionalFormgroupClasses"];export{k as __namedExportsOrder,O as default,c as primary,m as withFullWidthOverride,v as withHintTextAndErrorMessage,h as withLabelAsPageHeading,u as withNoItems,g as withOptionalFormgroupClasses,p as withSelectedValue};
//# sourceMappingURL=Select.stories.3f0148a5.js.map
