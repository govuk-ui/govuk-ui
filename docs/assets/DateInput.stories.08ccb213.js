import{D as o}from"./DateInput.46d20e7b.js";import"./jsx-runtime.999029ca.js";import"./index.ef27e5dc.js";import"./_commonjsHelpers.712cc82f.js";const a="date-input",u=[{name:"default",options:{id:"dob"},hidden:!1,html:`<div class="govuk-form-group">
...
</div>`}],d={component:a,fixtures:u},x={title:"DateInput",component:o},s={name:"default"},l={name:"complete question"},r={name:"with errors only"},v={name:"with errors and hint"},p={name:"with error on day input"},g={name:"with error on month input"},m={name:"with error on year input"},k={name:"with default items"},c={name:"with optional formgroup classes"},b={name:"with autocomplete values"},h={name:"with input attributes"},n=[];n.push(s);n.push(l);n.push(r);n.push(v);n.push(p);n.push(g);n.push(m);n.push(k);n.push(c);n.push(b);n.push(h);d.fixtures.forEach(t=>{let e=n.find(i=>i.name===t.name.replace(/[^a-z0-9s]/gi,""))||{};e.name===t.name&&(e.args={id:t.options.id,namePrefix:t.options.namePrefix,fieldset:t.options.fieldset,hint:t.options.hint,items:t.options.items,errorMessage:t.options.errorMessage,formGroup:t.options.formGroup,classes:t.options.classes,attributes:t.options.attributes})});const M=["primary","completeQuestion","withErrorsOnly","withErrorsAndHint","withErrorOnDayInput","withErrorOnMonthInput","withErrorOnYearInput","withDefaultItems","withOptionalFormgroupClasses","withAutocompleteValues","withInputAttributes"];export{M as __namedExportsOrder,l as completeQuestion,x as default,s as primary,b as withAutocompleteValues,k as withDefaultItems,p as withErrorOnDayInput,g as withErrorOnMonthInput,m as withErrorOnYearInput,v as withErrorsAndHint,r as withErrorsOnly,h as withInputAttributes,c as withOptionalFormgroupClasses};
//# sourceMappingURL=DateInput.stories.08ccb213.js.map
