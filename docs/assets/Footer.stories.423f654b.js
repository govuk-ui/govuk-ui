import{F as i}from"./Footer.c05f736b.js";import"./jsx-runtime.999029ca.js";import"./index.ef27e5dc.js";import"./_commonjsHelpers.712cc82f.js";const a="footer",s=[{name:"default",options:{},hidden:!1,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
    ...
    <div class="govuk-footer__meta">
      ...
      <div class="govuk-footer__meta-item">
        ...
        >\xA9 Crown copyright</a>
      </div>
    </div>
  </div>
</footer>`},{name:"with custom HTML content licence and copyright notice",options:{contentLicence:{html:'Mae\u2019r holl gynnwys ar gael dan <a class="govuk-footer__link" href="https://www.nationalarchives.gov.uk/doc/open-government-licence-cymraeg/version/3/" rel="license">Drwydded y Llywodraeth Agored v3.0</a>, ac eithrio lle nodir yn wahanol'},copyright:{html:"<span>Hawlfraint y Goron</span>"}},hidden:!1,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"with custom text content licence and copyright notice",options:{contentLicence:{text:"Mae\u2019r holl gynnwys ar gael dan Drwydded y Llywodraeth Agored v3.0, ac eithrio lle nodir yn wahanol"},copyright:{text:"\xA9 Hawlfraint y Goron"}},hidden:!1,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
    ...
    <div class="govuk-footer__meta">
      ...
      <div class="govuk-footer__meta-item">
        <a
          class="govuk-footer__link govuk-footer__copyright-logo"
          href="https://www.nationalarchives.gov.uk/information-management/re-using-public-sector-information/uk-government-licensing-framework/crown-copyright/"
        >\xA9 Hawlfraint y Goron</a>
      </div>
    </div>
  </div>
</footer>`},{name:"with meta",options:{meta:{visuallyHiddenTitle:"Items",items:[{href:"#1",text:"Item 1"},{href:"#2",text:"Item 2"},{href:"#3",text:"Item 3"}]}},hidden:!1,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"with custom meta",options:{meta:{text:"GOV.UK Prototype Kit v7.0.1"}},hidden:!1,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"with meta links and meta content",options:{meta:{items:[{href:"#1",text:"Bibendum Ornare"},{href:"#2",text:"Nullam"},{href:"#3",text:"Tortor Fringilla"},{href:"#4",text:"Tellus"},{href:"#5",text:"Egestas Nullam"},{href:"#6",text:"Euismod Etiam"},{href:"#7",text:"Fusce Sollicitudin"},{href:"#8",text:"Ligula Nullam Ultricies"}],html:'Built by the <a href="#" class="govuk-footer__link">Department of Magical Law Enforcement</a>'}},hidden:!1,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"with default width navigation (one column)",options:{navigation:[{title:"Navigation section",items:[{href:"#1",text:"Navigation item 1"},{href:"#2",text:"Navigation item 2"},{href:"#3",text:"Navigation item 3"},{href:"#4",text:"Navigation item 4"},{href:"#5",text:"Navigation item 5"},{href:"#6",text:"Navigation item 6"}]}]},hidden:!1,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"attributes",options:{attributes:{"data-test-attribute":"value","data-test-attribute-2":"value-2"}},hidden:!0,html:`<footer class="govuk-footer " role="contentinfo" data-test-attribute="value" data-test-attribute-2="value-2">
  <div class="govuk-width-container ">
...
</footer>`},{name:"classes",options:{classes:"app-footer--custom-modifier"},hidden:!0,html:`<footer class="govuk-footer app-footer--custom-modifier" role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"with container classes",options:{containerClasses:"app-width-container"},hidden:!0,html:`<footer class="govuk-footer " role="contentinfo">
...
</footer>`},{name:"with HTML passed as text content",options:{contentLicence:{text:'Mae\u2019r holl gynnwys ar gael dan <a class="govuk-footer__link" href="https://www.nationalarchives.gov.uk/doc/open-government-licence-cymraeg/version/3/" rel="license">Drwydded y Llywodraeth Agored v3.0</a>, ac eithrio lle nodir yn wahanol'},copyright:{text:"<span>Hawlfraint y Goron</span>"}},hidden:!0,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"with empty meta",options:{meta:{}},hidden:!0,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"with empty meta items",options:{meta:{items:[]}},hidden:!0,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"meta html as text",options:{meta:{text:"GOV.UK Prototype Kit <strong>v7.0.1</strong>"}},hidden:!0,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"with meta html",options:{meta:{html:"GOV.UK Prototype Kit <strong>v7.0.1</strong>"}},hidden:!0,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"with meta item attributes",options:{meta:{items:[{href:"#1",text:"meta item 1",attributes:{"data-attribute":"my-attribute","data-attribute-2":"my-attribute-2"}}]}},hidden:!0,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"with empty navigation",options:{navigation:[]},hidden:!0,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`},{name:"with navigation item attributes",options:{navigation:[{title:"Single column list 1",items:[{href:"#1",text:"Navigation item 1",attributes:{"data-attribute":"my-attribute","data-attribute-2":"my-attribute-2"}}]}]},hidden:!0,html:`<footer class="govuk-footer " role="contentinfo">
  <div class="govuk-width-container ">
...
</footer>`}],l={component:a,fixtures:s},b={title:"Footer",component:i},r={name:"default"},c={name:"with custom HTML content licence and copyright notice"},v={name:"with custom text content licence and copyright notice"},g={name:"with meta"},u={name:"with custom meta"},h={name:"with meta links and meta content"},f={name:"with default width navigation one column"},_={name:"with default width navigation two columns"},m={name:"with navigation"},k={name:"Full GDS example"},d={name:"Three equal columns"},n=[];n.push(r);n.push(c);n.push(v);n.push(g);n.push(u);n.push(h);n.push(f);n.push(_);n.push(m);n.push(k);n.push(d);l.fixtures.forEach(o=>{let e=n.find(t=>t.name===o.name.replace(/[^a-z0-9s]/gi,""))||{};e.name===o.name&&(e.args={contentLicence:o.options.contentLicence,copyright:o.options.copyright,meta:o.options.meta,navigation:o.options.navigation,attributes:o.options.attributes,classes:o.options.classes,containerClasses:o.options.containerClasses})});const C=["primary","withCustomHTMLContentLicenceAndCopyrightNotice","withCustomTextContentLicenceAndCopyrightNotice","withMeta","withCustomMeta","withMetaLinksAndMetaContent","withDefaultWidthNavigationoneColumn","withDefaultWidthNavigationtwoColumns","withNavigation","fullGDSExample","threeEqualColumns"];export{C as __namedExportsOrder,b as default,k as fullGDSExample,r as primary,d as threeEqualColumns,c as withCustomHTMLContentLicenceAndCopyrightNotice,u as withCustomMeta,v as withCustomTextContentLicenceAndCopyrightNotice,f as withDefaultWidthNavigationoneColumn,_ as withDefaultWidthNavigationtwoColumns,g as withMeta,h as withMetaLinksAndMetaContent,m as withNavigation};
//# sourceMappingURL=Footer.stories.423f654b.js.map
